...
grid on
subplot(3,1,2)
plot(tout,yref,'r',tout,y,'b')
title('Position y [m]','FontSize',18)
legend('reference','actual')
grid on
subplot(3,1,3)
plot(tout,thetaref*(180/pi),tout,theta*(180/pi),'b')
...
grid on
subplot(3,1,3)
plot(tout,vtheta*(180/pi))
title('Angular velocity [degree/s]','FontSize',18)
grid on

%% xy-plane Position of the quadrotor

figure(4)
plot(xref,yref,'r--',x,y)
legend('reference','actual')
